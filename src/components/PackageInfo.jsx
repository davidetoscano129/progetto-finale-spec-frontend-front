    ...
    <div className="package-info">
      ...
      <div className="package-details-grid">
        <div className="detail-row">
          ...
          <span className="detail-value">{packageData.details.duration} weeks</span>
        </div>

        <div className="detail-row price-row">
          <span className="detail-label">Price</span>
          <span className="detail-value price">{formatPrice(packageData.details.price)}</span>
        </div>

        <div className="detail-row">
          <span className="detail-label">Team Size</span>
          <span className="detail-value">{packageData.details.team_size} consultants</span>
        </div>

        <div className="detail-row">
          <span className="detail-label">Remote Option</span>
          <span className={`detail-value ${packageData.details.remote_option ? 'positive' : 'negative'}`}>
